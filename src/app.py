...
activities = {
    ...
    "Soccer Team": {
        "description": "Team training, fitness, and competitive soccer matches",
        "schedule": "Mondays and Wednesdays, 3:30 PM - 5:00 PM",
        "max_participants": 22,
        "participants": ["liam@mergington.edu", "ava@mergington.edu"]
    },
    "Track & Field Club": {
        "description": "Sprint, distance, and field event practice",
    ...
    "Science Olympiad": {
        "description": "Collaborative science challenges and competition prep",
