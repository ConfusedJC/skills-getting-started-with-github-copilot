...
def test_unregister_participant_returns_not_found_for_missing_student(client):
    # Arrange
    activity_name = "Chess Club"
...
def test_unregister_participant_returns_not_found_for_unknown_activity(client):
    # Arrange
    activity_name = "Unknown Club"
    email = "student@mergington.edu"
    endpoint = f"/activities/{activity_name}/participants/{email}"
